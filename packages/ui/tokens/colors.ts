...
export const lightColors = {
  ...
  textSubtle: '#7A6EAA',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(184deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 28%, rgba(249,236,250,1) 67%, rgba(251,251,251,1) 100%)',
  gradientInverseBubblegum: 'linear-gradient(184deg, rgba(156,156,156,1) 0%, rgba(255,255,255,1) 28%, rgba(249,236,250,1) 67%, rgba(251,251,251,1) 100%)',
