...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://towerswap.finance/images/tokens/${token.address[512512]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://towerswap.finance/images/tokens/${token.address[512512]}.svg`;
        const secondarySrc = `https://towerswap.finance/images/tokens/${tokens[randomTokenIndex].address[512512]}.svg`;
