...
const CHART_SUPPORT_CHAIN_IDS = [ChainId.CMP_TESTNET, ChainId.CMP]
const ACCESS_TOKEN_SUPPORT_CHAIN_IDS = [ChainId.CMP_TESTNET]
const STABLE_SUPPORT_CHAIN_IDS = [ChainId.CMP_TESTNET, ChainId.CMP]
