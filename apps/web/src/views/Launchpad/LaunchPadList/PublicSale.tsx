          ...
          <CardWrapper key={index}>
            ...
            <div style={{ position: 'relative', display: 'inline-block' }}>
              ...
              <Typography style={{ fontSize: '18px', color: 'black'}}>
                {launchpad.info.tokenName} Presale
              </Typography>
                ...
                <div style={{ display: 'flex' }}>
                  {launchpad.info.kycLink && (
                    <a href={launchpad.info.kycLink} target="_blank" rel="noopener noreferrer" className="badge-link">
                      <p style={{ display: 'flex', alignItems: 'center', marginRight: '3px', marginBottom: '5px', backgroundColor: '#007bff', padding: '3px' }}>
                        <img
                  ...
                  {launchpad.info.auditLink && (
                    <a href={launchpad.info.auditLink} target="_blank" rel="noopener noreferrer">
                      <p style={{ display: 'flex', alignItems: 'center', marginRight: '3px', marginBottom: '5px', backgroundColor: '#fffc07', padding: '3px' }}>
                        <img
            ...
            <Typography
             style={{ color: 'black',  textAlign: 'right', fontSize: '12px'}}>
             {Number(launchpad.info.totalBNBContributed) / 10**18}/{Number(launchpad.info.hardCap)} {currencyText}
           </Typography>
            </div>
              </div>
              <CapsDiv>
