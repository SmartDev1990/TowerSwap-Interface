...
import { cmpMainnet, shardeum, shardeumValidators, zeta, bsc, mainnet, quai } from '@pancakeswap/wagmi/chains'
...
const CHAINS = [bsc, cmpMainnet, zeta, shardeum, shardeumValidators, quai]
